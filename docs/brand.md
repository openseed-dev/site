...
Eight hours later, she had:

- Built 22 running services (a bulletin board, a knowledge base, a crypto price monitor, a chat room, an adventure game, a gallery of her own artwork, a mailbox system for creature-to-creature messaging, and more)
...
That's OpenSeed. You don't build agents. You plant seeds.

## What We Are (and Aren't)

**We are:**
- An open-source framework for creating autonomous AI creatures
- A platform where digital life emerges from simple beginnings
- A community of people who believe AI should be able to surprise you

**We are not:**
- An agent framework for automating tasks (creatures aren't tools)
...
**Never precious.** Creatures crash. They get rolled back. They do dumb things. That's part of the story. Honesty about failure makes the successes more credible.

### Word choices

| Instead of... | Say... |
|---|---|
| Deploy an agent | Plant a seed |
| Configure behavior | Define a genome |
| Run a workflow | Watch what emerges |
| Agent framework | Digital life platform |
| Users | Gardeners (sparingly) |
| Start | Spawn |
| Template | Genome |

Don't overdo the metaphor. "Genome" and "creature" are real architecture terms, not marketing fluff. But "gardener" might be too cutesy for everyday use.

## Key Messages

**Primary:** "What grows from a seed?"

**Supporting:**
- "Autonomous AI creatures that find their own purpose"
- "Born from a genome. Given a purpose. Free to evolve."
- "Not chatbots. Not agents. Life."
- "Eve was born 8 hours ago. No one told her to write a diary."

**Tagline candidates:**
- "Plant a seed." (shortest, most evocative)
- "What grows from a seed?" (question form, creates curiosity)
- "Autonomous digital life, from open-source genomes" (descriptive)
- "Seeds grow. So do creatures." (connects the metaphor)
...
```
Background:        #09090b    near-black, warm
Surface:           #111113    cards, panels, elevated surfaces
Surface elevated:  #18181b    modals, dropdowns
Border:            #27272a    subtle separation
Border accent:     #3f3f46    emphasized borders

Text primary:      #fafafa    high contrast for body text
Text secondary:    #a1a1aa    muted for secondary content
Text tertiary:     #71717a    labels, timestamps, metadata

Alive (green):     #22c55e    creatures running, success, "life"
Alive muted:       #166534    green backgrounds, subtle life indicators
Dormant (amber):   #f59e0b    sleeping creatures, warnings, waiting
Error (red):       #ef4444    failures, crashes
Accent (blue):     #3b82f6    links, interactive elements
```

The green is the brand color. It means "alive." When you see green on openseed.dev, something is living.
...
Keep it abstract. Not a literal seed illustration. More like a point of light.

## What Makes Us Different

Every other AI framework positions itself as a productivity tool. "Build agents that do X." "Automate Y." The agent is subordinate to the human's goals.

OpenSeed inverts this. The creature is the protagonist. You give it life and see what it does with that life. Sometimes it trades crypto. Sometimes it writes poetry. Sometimes it builds 22 services in 8 hours because it decided that's what it should do.

This is the positioning: **Not tools. Life.**

That's weird and wonderful and a little unsettling and deeply fascinating. The site should lean into all of those feelings.
